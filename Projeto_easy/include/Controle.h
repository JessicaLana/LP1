...
class Controle{
    ...
    void getSignal(int n); /*!< Determines which signal shall be sent to server and returns it, then updates mSignal*/
    void captureLoop(); /*!< Main capture loop, processes each frame with Detector::detect and updates center and mSignal*/
    void captureLoopDlib();
